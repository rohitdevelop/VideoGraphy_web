  ...
  const details = [
    {
      ...
      description:
        "Capturing the magic of your special day with timeless wedding photography that tells your unique love story.",
      points: [
        "Pre-Wedding Shoots",
        "Full-Day Coverage",
        "Candid & Posed Shots",
    ...
    },
    {
      ...
      description:
        "Professional coverage of conferences, seminars, and corporate gatherings that showcase your brand excellence.",
      points: [
        "Conference Coverage",
    ...
    },
    {
      ...
      description:
        "Creating stunning visual narratives with high-quality cinematic videography that brings your story to life.",
      points: [
        "4K Video Production",
        "Drone Footage",
    ...
    },
    {
      ...
      description:
        "Professional portraits that capture personality and character, perfect for personal or business use.",
      points: [
        "Studio Sessions",
        "Outdoor Shoots",
        "Family Portraits",
    ...
    },
    {
      ...
      description:
        "Complete documentation of birthdays, anniversaries, and special celebrations with creative storytelling.",
      points: [
        "Birthday Parties",
    ...
    },
    {
      ...
      description:
        "High-end fashion shoots and commercial photography that elevate brands with stunning visual content.",
      points: [
        "Fashion Shoots",
        "Product Photography",
        "Brand Campaigns",
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-16 lg:mb-20">
          {details.map((service) => (
            ...
            >
              {/* Icon */}
              <div
                className={`flex items-center justify-center w-16 h-16 bg-${service.iconBg} rounded-xl mb-4 group-hover:scale-110 transition-transform duration-300 text-${service.iconColor}`}
              >
                {service.icon}
              </div>
              ...
              <ul className="space-y-2">
                {service.points.map((point, index) => (
                  <li
                    key={index}
                    className="flex items-start gap-2 text-gray-300 text-sm lg:text-base"
                  >
