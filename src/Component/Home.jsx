          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 min-h-[calc(100vh-200px)]">
            ...
            <div className="flex-1 text-center lg:text-left space-y-6 lg:space-y-8">
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
                ...
                India, we deliver premium visual storytelling that immortalizes
                your moments.
              </p>
              ...
              {/* Stats Section */}
              <div className="grid grid-cols-3 gap-4 lg:gap-8 pt-8 max-w-2xl mx-auto text-center">
                <div className="flex flex-col items-center justify-center bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/10 rounded-xl p-4 lg:p-6">
                  <Users className="w-6 h-6 lg:w-8 lg:h-8 text-red-400 mb-2" />
                  <h3 className="text-2xl lg:text-4xl font-bold text-white mb-1">
                    500+
                  </h3>
                ...
                <div className="flex flex-col items-center justify-center bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/10 rounded-xl p-4 lg:p-6">
                  <Camera className="w-6 h-6 lg:w-8 lg:h-8 text-red-400 mb-2" />
                  <h3 className="text-2xl lg:text-4xl font-bold text-white mb-1">
                    1000+
                  </h3>
                  <span className="text-gray-400 text-xs lg:text-sm">
                ...
                <div className="flex flex-col items-center justify-center bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/10 rounded-xl p-4 lg:p-6">
                  <Award className="w-6 h-6 lg:w-8 lg:h-8 text-red-400 mb-2" />
                  <h3 className="text-2xl lg:text-4xl font-bold text-white mb-1">
                    15+
                  </h3>
                  <span className="text-gray-400 text-xs lg:text-sm">
            ...
            <div className="flex-1 w-full max-w-lg lg:max-w-none">
              <div className="relative group">
                ...
                <div className="relative h-64 sm:h-80 lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden border-2 border-white/10 group-hover:border-red-500/50 transition-all duration-500">
                  <Image
                    src="https://img.freepik.com/premium-photo/cameraman-shooting-wedding-with-video-camera_665346-44223.jpg"
